const exercises = [
  ...
  },
  {
    ...
    premium: false,
    description:
      'Arrodíllate en el suelo. Extiende los brazos y separa las manos a la anchura de los hombros en el suelo frente a ti. Apriete los abdominales mientras dobla los brazos, bajando el torso hasta que el pecho roce el suelo. Empuje el torso hacia arriba enderezando los brazos. Lento, constante y repita.',
  },
  {
  ...
  },
  {
    ...
    premium: false,
    description:
      'Acuéstese boca arriba con las rodillas dobladas y los pies anclados.Meta la barbilla en el pecho para alargar la parte posterior del cuello.Entrelaza los dedos en la base del cráneo, cruza los brazos con las manos sobre hombros opuestos o coloca las palmas de las manos junto al cuerpo.Exhala mientras levantas la parte superior del cuerpo hacia los muslos. Inhala mientras te bajas lentamente hacia el suelo.',
  },
  {
    name: 'KNEE LIFT',
    difficulty: 'easy',
  ...
  },
  {
    ...
    premium: false,
    description:
      'Comience en una posTan pronto como aterrices con las rodillas dobladas, ponte en cuclillas y haz otra repetición.',
  },
  {
    name: 'UP/DOWN PLANKS',
    difficulty: 'medium',
  ...
  },
  {
    ...
    premium: true,
    description:
      'Comience en posición de tabla con los brazos extendidos y las manos debajo de los hombros, los pies juntos. Su cuerpo debe estar en línea recta desde la cabeza hasta los talones.Salta ambos pies hacia cada lado como si estuvieras haciendo un salto horizontal. Manténgase en posición de tablón mientras salta rápidamente los pies de nuevo juntos. Continúe saltando hacia adentro y hacia afuera. Mantén la espalda plana y no dejes que las caderas caigan durante todo el movimiento. Sus brazos deben permanecer estables.',
  },
  {
    name: 'REVERSE LUNGE',
    difficulty: 'easy',
  ...
  },
  {
    ...
    premium: true,
    description:
      'Este ejercicio se centra en los glúteos, la parte posterior de las piernas y en la parte baja de la espalda. Acuéstate boca arriba, con las piernas preparadas y en posición. Estira una de las piernas en el aire, presionando la pelvis hacia arriba y tratando de que la cadera quede siempre recta.',
  },
  {
    name: 'LEG RAISES',
    difficulty: 'easy',
    ...
    premium: true,
    description:
      'Acuéstate boca arriba con las piernas estiradas. Levante las piernas hacia arriba hasta que queden de forma perpendicular con respecto a la cadera. Ten cuidado de no arquear la columna al hacer el ejercicio. Si esto no te resulta sencillo, coloca las dos manos por debajo de las nalgas.',
  },
  {
    name: 'CRUNCHES',
    difficulty: 'easy',
    ...
    premium: false,
    description:
      'Recuéstate en el suelo con tu espalda completamente apoyada, si tu espalda baja se despega ligeramente, respeta la curvatura natural y no intentes hacer tensarla contra el piso. Coloca tus manos detrás de tu cabeza, para soportar su peso. No las coloques detrás del cuello, esto puede generar tensión.',
  },
  {
    name: 'BICYCLE CRUNCH',
    difficulty: 'hard',
  ...
  },
  {
    ...
    premium: false,
    description:
      'Comienza en posición de plancha, con las piernas juntas y estiradas comienza a dar saltos de hacia los costados intercaladamente llevando las rodillas hacia el pecho al momento del aterrizaje menos al momento del salto hacia el medio, en ese momento se mantienen las piernas estiradas.',
  },
  {
    name: 'SCISSOR DROP',
    difficulty: 'medium',
  ...
  },
  {
    ...
    premium: false,
    description:
      'Ejecución. Manteniendo la espalda plana, de un paso con un pie al lado de su mano o tan cerca como pueda. Puede permitir que la rodilla opuesta se doble ligeramente mientras se inclina hacia el estiramiento. Mantenga el estiramiento durante el tiempo deseado y luego repita con la pierna opuesta.',
  },
  {
    name: 'DEADLIFT',
    difficulty: 'medium',
  ...
  },
  {
    ...
    premium: true,
    description:
      'Salta sobre la cuerda con los dos pies juntos a un ritmo moderado. Mantén los tobillos y rodillas relajados para absorber el impacto. Trata de que sea un movimiento fluido en lugar de dos posiciones diferentes. Aumenta la velocidad de la cuerda y el ritmo al que saltas.',
  },
  {
    ...
    premium: false,
    description:
      'Primero colócate sentado en el suelo con las escápulas apoyadas en un banco. Las plantas de los pies quedan fijadas al suelo. Deberás colocarte una barra a la altura de la cadera. Realiza un empuje de cadera tratando de subir la cadera a la horizontal y elevar la barra del suelo.',
  },
  {
    name: 'WEIGHT SQUATS ',
    difficulty: 'medium',
    ...
    premium: false,
    description:
      'Escoge una pesa/mancuerna/barra con el peso deseado. Coloca tus piernas abiertas con los pies a la altura de los hombros. Se debe llevar a cabo un movimiento ligero de cadera. Esta se mueve hacia atrás y abajo, mientras que el pecho permanece hacia arriba y el peso del cuerpo cae en los talones. Las rodillas no debes flexionarlas demasiado para evitar que acaben en los dedos de los pies.',
  },
  {
    name: 'DUMBBELL PRESS',
    difficulty: 'easy',
    ...
    premium: true,
    description:
      'Túmbate en un banco plano y echa los hombros hacia atrás. En el press de banca es importante hacer un agarre adecuado. Ahora levanta la barra, tomando aire al mismo tiempo que contraes glúteos, espalda y omóplatos fijos. Coloca la barra sobre el pecho de forma lenta y controlada. Luego vuelve a subir.',
  },
  {
    name: 'PARALLEL DIPS',
    difficulty: 'hard',
  ...
  },
  {
    ...
    premium: true,
    description:
      'El Press Militar o también llamado press estricto es un ejercicio de fuerza muy popular que consiste en levantar el peso sobre la cabeza con los brazos sin ningún impulso previo. Este ejercicio generalmente se realiza de pie, pero también tiene muchas variaciones, como realizarlo sentado.',
  },
  {
    name: 'ARNOLD PRESS',
    difficulty: 'hard',
  ...
  },
  {
    ...
    premium: true,
    description:
      'De pie, con los pies separados a una distancia aproximadamente igual a la anchura de los hombros, manteniendo los codos flexionados con el húmero paralelo al suelo. Realizar una inspiración profunda para que la presión intratorácica impida que el tronco se incline hacia adelante, arquear ligeramente la zona lumbar, contraer el core y flexionar las rodillas hasta que alcancen la horizontal.Regresar a la posición inicial y espirar al final del movimiento',
  },
  {
  ...
  },
  {
    ...
    premium: true,
    description:
      'Encuentre un escalón, banco o cualquier otro dispositivo en el que pueda apoyar su pie que esté a la altura de la rodilla. Con el pie trasero elevado en el banco, realice una estocada hacia adelante con el torso erecto, el núcleo arriostrado y las caderas cuadradas a su cuerpo. Su pierna delantera debe estar alrededor de medio metro por delante del banco. Baje la parte delantera del muslo hasta que esté casi horizontal, manteniendo la rodilla en línea con el pie.',
  },
  {
    name: 'DROP SQUAT',
    difficulty: 'medium',
  ...
  },
  {
    ...
    premium: false,
    description:
      'Comience en una posición sentada en el suelo con las piernas rectas frente a usted. Siéntese alto con los abdominales apretados con los codos doblados al lado de su lado. Tire los brazos hacia atrás hasta que estén al lado de su lado y los codos estén detrás de usted. Suelte lentamente.',
  },
  {
    name: 'BACK EXTENSION',
    difficulty: 'easy',
  ...
  },
  {
    ...
    premium: false,
    description:
      'Asuma una posición de pie e inclínese ligeramente hacia adelante girando hacia las caderas. Inicia el movimiento extendiendo los codos y flexionando el tríceps. Tire hacia abajo hasta que los codos estén casi bloqueados y luego baje lentamente bajo control de nuevo a la posición inicial.',
  },
  {
    name: 'BAND PULLS',
    difficulty: 'easy',
  ...
  },
  {
    ...
    genre: 'both',
    video:
      'https://media2.giphy.com/media/NYYDleLApDMxf3P3b7/giphy.gif?cid=ecf05e47qv54p1muev3d1qkxtfah60jtaxdr347dqel7r2nn&rid=giphy.gif&ct=g',
    premium: true,
    description:
      'Eleva un hombro hasta colocarlo a 90º, y con la otra mano, ejerce presión sobre el codo, moviendolo hacia el lado del hombro contrario, estirando y manteniendo la tensión durante 15 segundos. Repite el movimiento tres veces.',
  },
  {
  ...
  },
  {
    ...
    premium: true,
    description:
      'Recuestate, estira una pierna y flexiona la contraria, coloca la mano sobre la rodilla de la pierna flexionada y llevala hacia el pecho. ¡No te olvides de respirar correctamente!',
  },
  {
  ...
  },
  {
    ...
    genre: 'both',
    video:
      'https://cdn-prod.medicalnewstoday.com/content/images/articles/325/325373/shoulder-roll-stretch-and-exercise-gif.gif',
    premium: true,
    description:
  ...
  },
  {
    ...
    genre: 'both',
    video:
      'https://www.healthline.com/hlcmsresource/images/topic_centers/Fitness-Exercise/400x400_10_Essential_Stretches_For_Runners_Quadriceps.gif',
    premium: true,
    description:
      'Trabaja los cuádriceps tirando la pierna hacia atrás con la ayuda de la mano y llevándola hacia los glúteos. Repite el ejercicio tres veces con cada pierna.',
  },
  {
    ...
    genre: 'both',
    video:
      'https://i0.wp.com/images-prod.healthline.com/hlcmsresource/images/topic_centers/Fitness-Exercise/648x364_3_Wrist_Exercises_to_Prevent_Carpal_Tunnel_EXERCISE_3.gif?w=1155&h=764',
    premium: true,
    description:
      'Estira el brazo hacia delante con la palma dirigida hacia el suelo y luego flexiona hasta que la mano quede vertical, con la ayuda de la otra mano.',
  },
  {
    ...
    premium: true,
    description:
      'Colócate en posición de cuadrupedia y asegúrate que tus muñecas están correctamente alineadas bajo los hombros y las rodillas bajo las caderas, abiertas a su misma anchura. Coloca la espalda recta y el cuello neutro. Inhalando, arquea la espalda mientras dejas caer el abdomen hacia abajo, elevando el pecho y la barbilla hacia el techo. Exhala metiendo el abdomen y redondeando la columna con la barbilla hacia el pecho y la mirada hacia al abdomen',
  },
  {
    name: 'LUMBAR STRETCHING',
    difficulty: 'medium',
  ...
  },
  {
    ...
    premium: true,
    description:
      '  De pie, con las manos tocando tus rodillas. Haz un salto vertical extendiendo brazos y piernas hacia los laterales. Al caer, vuelve de nuevo a la posición inicial.',
  },

  {
    ...
    genre: 'both',
    video:
      'https://1.bp.blogspot.com/-jGl5Pw7RZ6U/WMYClRXel4I/AAAAAAAAINE/ZEgM_uJ1tG8dsGtNwLEldIEaCqnkoyU7QCLcB/s640/Lunges.gif',
    premium: false,
    description:
      ' Da un paso largo hacia adelante, toca con la rodilla de la pierna trasera el suelo. Vuelve al inicio y repite con la otra pierna.',
  },

  {
    ...
    premium: false,
    description:
      'Estírate boca abajo con las manos a la altura de los hombros. Extiende los brazos, levanta el tronco y mantén la cadera en el suelo. ',
  },
...

  {
    ...
    premium: false,
    description:
      'Párate a un lado de tu silla. Pon un pie sobre él y otro déjalo en el suelo. Empuja a través del talón del pie en el banco, sube para extender completamente la pierna, luego baja lentamente hacia abajo para comenzar.',
  },
  {
    name: 'RUSSIAN TWIST',
    difficulty: 'hard',
  ...
  },
  {
    ...
    premium: true,
    description:
      'Empezamos en cuclillas, colocamos las manos en el suelo, mantenemos la cabeza erguita y hay que lanzar las piernas hacia atrás con los pies juntos. Además de abdominales, fortalece piernas y brazos.',
  },
  {
    ...
    premium: true,
    description:
      'Igual que el sit up original (Acuéstese boca arriba con las rodillas dobladas y los pies anclados.Meta la barbilla en el pecho para alargar la parte posterior del cuello.Entrelaza los dedos en la base del cráneo, cruza los brazos con las manos sobre hombros opuestos o coloca las palmas de las manos junto al cuerpo.Exhala mientras levantas la parte superior del cuerpo hacia los muslos. Inhala mientras te bajas lentamente hacia el suelo) pero con el handicap de utilizar material pesado, en este caso un balón medicinal.',
  },
  {
    name: 'FIT BALL PASS',
    difficulty: 'medium',
  ...
  },
  {
    ...
    genre: 'woman',
    video:
      'https://www.foodspring.es/magazine/wp-content/uploads/2020/11/Calisthenics-Workout-Situps-Giannis_%C2%A9foodspring.gif',
    premium: false,
    description:
