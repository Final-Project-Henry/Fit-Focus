        ...
        <nav className=' border-gray-200 px-2 sm:px-4  bg-white  w-full border-b-4'>
          <div className='container-fluid w-full flex flex-wrap items-center justify-between px-8 p-4'>
            <div className='flex items-center'>
              <img src={icon} className='mr-3 h-6 sm:h-9 cursor-default' alt='FF Logo' />
              ...
              {dropdown && (
                ...
                >
                  <div className='py-3 px-4'>
                    <span className='block text-3xl text-gray-900'>{userInfo?.name}</span>
                    <span className='block text-sm font-medium text-gray-500 truncate '>{userInfo?.email}</span>
                  </div>
