          ...
          <div className="w-full p-8 lg:w-1/2">
            ...
            <div className="mt-4">
              ...
              <input
                type="text"
                name="name"
                className={`${error.name} bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300-2 px-4 block w-full appearance-none`}
                autoComplete="off"
                placeholder="Alex"
            ...
            <div className="mt-4">
              ...
              <input
                className={`${error.email} bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300-2 px-4 block w-full appearance-none`}
                type="email"
                name="email"
            ...
            <div className="mt-4">
              ...
              <input
                className={`${error.password} bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300-2 px-4 block w-full appearance-none`}
                type="password"
                name="password"
                autoComplete="off"
                placeholder="••••••••"
