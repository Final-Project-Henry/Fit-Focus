...
const ProfileDetails = ({ name, email, plan, age, equipment, experience, genre, goal, height, weight }: Props) => {
  ...
  const handleClickStateUser = async (type: string) => {
    ...
    if ((statusUser.age && statusUser.age < 20) || (statusUser.age && statusUser.age > 66) || statusUser?.age === 0)
      return setError({ ...error, age: true })
    else if (
      (statusUser.height && statusUser.height < 120) ||
      (statusUser.height && statusUser.height > 220) ||
      statusUser?.height === 0
    )
      return setError({ ...error, height: true })
    else if (
      (statusUser.weight && statusUser.weight < 20) ||
      (statusUser.weight && statusUser.weight > 120) ||
      statusUser?.weight === 0
    )
      return setError({ ...error, weight: true })
    else {
            ...
            <div className='p-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl'>
              <div className='flex flex-wrap -mx-3'>
                <div className='flex items-center w-full max-w-full px-3 shrink-0 md:w-auto md:flex-none'>
                  <h6 className='mb-0 font-bold text-xl'>
                    {editable.info ? 'Editar usuario' : 'Detalles del usuario'}
                  </h6>
                </div>
                ...
                {editable.info ? (
                  <div>
                    ...
                    <svg
                      id='save'
                      onClick={() => handleClickInfoUser('save')}
                      xmlns='http://www.w3.org/2000/svg'
                      className='cursor-pointer absolute right-11 top-2.5 w-6 h-6 pt-0.5 mt-[1px] hover:drop-shadow-[0_4px_1px_rgba(0,200,0,0.4)] hover:duration-500 hover:scale-110 hover:stroke-green-500 delay-100 duration-500'
                      viewBox='0 0 24 24'
                      fill='none'
                      stroke='black'
                      strokeWidth='2'
                    ...
                    <svg
                      id='cancel'
                      onClick={() => handleClickInfoUser('cancel')}
                      xmlns='http://www.w3.org/2000/svg'
                      className='fill-black hover:scale-110 hover:fill-red-600 hover:duration-500 duration-500 cursor-pointer absolute right-1.5 top-1.5 w-9 h-9 hover:drop-shadow-[0_4px_1px_rgba(200,0,0,0.4)]'
                    ...
                    >
                      <path
                        ...
                        strokeWidth='0.2'
                        strokeLinejoin='round'
                        d='M 38,19C 48.4934,19 57,27.5066 57,38C 57,48.4934 48.4934,57 38,57C 27.5066,57 19,48.4934 19,38C 19,27.5066 27.5066,19 38,19 Z M 38,23.75C 35.2116,23.75 32.6102,24.5509 30.4134,25.9352L 50.0648,45.5866C 51.4491,43.3898 52.25,40.7884 52.25,38C 52.25,30.13 45.87,23.75 38,23.75 Z M 23.75,38C 23.75,45.8701 30.1299,52.25 38,52.25C 40.7884,52.25 43.3897,51.4491 45.5865,50.0649L 25.9351,30.4136C 24.5509,32.6103 23.75,35.2117 23.75,38 Z '
                      />
                    </svg>
                  </div>
                ) : (
                  <svg
                    onClick={() => handleClickEditable('info')}
                    className='w-5 h-5 right-3 top-3 absolute cursor-pointer hover:scale-110 hover:duration-500 duration-500 delay-100 hover:drop-shadow-[0_3px_1px_rgba(0,0,200,0.3)]'
                    xmlns='http://www.w3.org/2000/svg'
                    xmlnsXlink='http://www.w3.org/1999/xlink'
                    version='1.1'
                    x='0px'
              ...
              <ul className='flex flex-col pl-0 mb-0 rounded-lg'>
                <li className='relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-size-base text-inherit'>
                  ...
                  <ContentEditable
                    ...
                    spellCheck={false}
                    className={`${
                      error.name && 'border-b-2 border-red-400 hover:border-red-500 focus:border-red-600'
                    } ${
                      editable.info && 'border-b-2 border-gray-200 hover:border-gray-500 focus:border-blue-600'
                    }  duration-500 delay-100  rounded-b-lg outline-none px-2 inline`}
                  />
                </li>
                {/*  */}
                <li className='relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-size-base text-inherit'>
                  ...
                  <ContentEditable
                    ...
                    spellCheck={false}
                    className={`${
                      error.email && 'border-b-2 border-red-400 hover:border-red-500 focus:border-red-600'
                    } ${
                      editable.info && 'border-b-2 border-gray-200 hover:border-gray-500 focus:border-blue-600'
                    }  duration-500 delay-100 rounded-b-lg outline-none px-2 inline`}
                  />
                ...
                {/*  */}
                <li
                  className={`relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-size-base text-inherit `}
                >
                  <strong className='text-slate-700 mr-2'>
                    {editable.info && plan === 'normal' ? 'Mejora tu plan:' : 'Tipo de plan:'}
                  </strong>
                  <span
                    className={`font-semibold ${
                      plan === 'normal' ? 'text-[#46b357]' : plan === 'premium' && 'text-[#efb810]'
                    }`}
                  >
                  ...
                  {editable.info && plan === 'normal' && (
                    <button
                      ...
                      className='bg-transparent hover:text-[#efb810] font-semibold ml-3 py-0.5 px-1.5 border border-[#efb810] duration-500 hover:border-transparent rounded'
                    >
              ...
              <div className='p-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl'>
                <div className='flex flex-wrap -mx-3'>
                  <div className='flex items-center w-full max-w-full px-3 shrink-0 md:w-8/12 md:flex-none'>
                    <h6 className='mb-0 font-bold text-xl'>
                      {editable.status ? 'Editar perfil' : 'Detalles del perfil'}
                    </h6>
                  </div>
                  <div className='w-full max-w-full px-3 text-right shrink-0 md:w-4/12 md:flex-none'>
                    <a data-target='tooltip_trigger' data-placement='top'>
                  ...
                  {editable.status ? (
                    <div>
                      {/* Save */}
                      <svg
                        onClick={() => handleClickStateUser('save')}
                        className='cursor-pointer absolute right-11 top-2.5 w-6 h-6 pt-0.5 mt-[1px] hover:drop-shadow-[0_4px_1px_rgba(0,200,0,0.4)] hover:duration-500 hover:scale-110 hover:stroke-green-500 delay-100 duration-500'
                        viewBox='0 0 24 24'
                        fill='none'
                        stroke='black'
                      ...
                      {/* Cancel */}
                      <svg
                        onClick={() => handleClickStateUser('cancel')}
                        xmlns='http://www.w3.org/2000/svg'
                        className='fill-black hover:scale-110 hover:fill-red-600 hover:duration-500 duration-500 cursor-pointer absolute right-1.5 top-1.5 w-9 h-9 hover:drop-shadow-[0_4px_1px_rgba(200,0,0,0.4)]'
                        xmlnsXlink='http://www.w3.org/1999/xlink'
                        viewBox='0 0 76 76'
                    ...
                    <svg
                      onClick={() => handleClickEditable('status')}
                      className='w-5 h-5 right-3 top-3 absolute cursor-pointer hover:scale-110 hover:duration-500 duration-500 delay-100 hover:drop-shadow-[0_3px_1px_rgba(0,0,200,0.3)]'
                      xmlns='http://www.w3.org/2000/svg'
                      xmlnsXlink='http://www.w3.org/1999/xlink'
                      version='1.1'
                ...
                <ul className='grid grid-flow-row grid-cols-2 pl-0 mb-0 rounded-lg'>
                  <li className='relative block px-4 pb-2 pl-0 leading-normal bg-white border-0 border-t-0 text-size-base text-inherit'>
                    ...
                    <ContentEditable
                      ...
                      spellCheck={false}
                      className={`${
                        error.weight && 'border-b-2 border-red-400 hover:border-red-500 focus:border-red-600'
                      } ${
                        editable.status && 'border-b-2 border-gray-200 hover:border-gray-500 focus:border-blue-600'
                      }  duration-500 delay-100 rounded-b-lg outline-none px-2 inline`}
                    />
                    {statusUser.weight !== undefined && (
                      <span className={`${editable.status && 'ml-1 text-gray-400 duration-500'} ml-0`}>kg</span>
                    )}
                  </li>
                  {/*  */}
                  <li className='relative block px-4 pb-2 pl-0 leading-normal bg-white border-0 border-t-0 text-size-base text-inherit'>
                    ...
                    <ContentEditable
                      ...
                      spellCheck={false}
                      className={`${
                        error.age && 'border-b-2 border-red-400 hover:border-red-500 focus:border-red-600'
                      } ${
                        editable.status && 'border-b-2 border-gray-200 hover:border-gray-500 focus:border-blue-600'
                      }  duration-500 delay-100 rounded-b-lg outline-none px-2 inline`}
                    />
                    {statusUser.weight !== undefined && (
                      <span className={`${editable.status && 'ml-1 text-gray-400 duration-500'} ml-0`}>años</span>
                    )}
                  </li>
                  {/*  */}
                  <li className='relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-size-base text-inherit'>
                    ...
                    <ContentEditable
                      ...
                      spellCheck={false}
                      className={`${
                        error.height && 'border-b-2 border-red-400 hover:border-red-500 focus:border-red-600'
                      } ${
                        editable.status && 'border-b-2 border-gray-200 hover:border-gray-500 focus:border-blue-600'
                      }  duration-500 delay-100 rounded-b-lg outline-none px-2 inline focus:border-blue-600`}
                    />
                    {statusUser.weight !== undefined && (
                      <span className={`${editable.status && 'ml-1 text-gray-400 duration-500'} ml-0`}>cm</span>
                    )}
                  </li>
                  {/*  */}
                  <li className='relative block px-4 py-2 pl-0 leading-normal bg-white border-0 rounded-t-lg text-size-base text-inherit'>
                    <strong className='text-slate-700 mr-0.5'>{editable.status ? 'Editar equipo:' : 'Equipo:'}</strong>
                    {editable.status ? (
                      <select
                        onChange={handleChangeStatus}
                        className='inline h-6 pr-8 pl-1.5 py-0 border-0 border-b-[1px] rounded-b-lg'
                        name='equipment'
                        id='select'
                      >
                  ...
                  {/*  */}
                  <li className='relative block px-4 py-2 pl-0 leading-normal bg-white border-0 rounded-t-lg text-size-base text-inherit'>
                    <strong className='text-slate-700 mr-0.5'>{editable.status ? 'Editar Genero:' : 'Genero:'}</strong>
                    {editable.status ? (
