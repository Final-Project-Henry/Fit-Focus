...
const Carousel: React.FC<Props> = ({
  ...
  return (
    <div className="w-[98%] max-h-[300px] flex content-center overflow-hidden rounded-xl ">
            ...
            ({ src, text, stylesContent, stylesImage, stylesText }) => {
              ...
              return (
                ...
                >
                  {text && (
                    <div
                      className="absolute bg-[#cc00ff8f]  flex flex-col  w-full p-20  text-white z-10"
                    >
                      <p className=" font-extrabold  w-[50%] text-[2rem]">
                      {text}
                      </p>
                    <Link to="/mercadopago" className="inline-flex items-center py-2 px-3 w-20 text-sm font-medium text-center text-white bg-[#6c63ff] duration-150 rounded-lg hover:bg-blue-800">
                      Premium
                    </Link>
                    </div>
                  )}
