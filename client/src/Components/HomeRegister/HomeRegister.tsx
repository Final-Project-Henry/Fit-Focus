          ...
          <section className="grid grid-cols-3">
            {ejercicios?.map(
              ({
                ...
                return (
                  <>
                    <div className={`max-w-sm flex flex-col bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 duration-150 cursor-pointer scale-90 hover:scale-95  hover:outline hover:outline-offset-1 ${
                        premium
                          ? "outline-blue-400"
                          : difficulty == "easy"
                          ? "outline-green-400"
