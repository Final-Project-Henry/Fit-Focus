        ...
        <div className="flex fl space-x-8 mt-5 justify-between">
          <div className="w-52 h-52 bg-cover">
            <img
              ...
              src="https://cdn2.actitudfem.com/media/files/media/files/wall-sit.gif"
            />
          </div>
          <div className="bg-red-600 w-52 h-52">
            <img
              className="w-full h-full bg-cover cursor-pointer"
              src="https://c.tenor.com/NYyx3iSx_gwAAAAd/home-workouts-exercise.gif"
            />
          </div>
          <div className="bg-red-700 w-52 h-52">
            <img
              className="cursor-pointer"
              src="https://thumbs.gfycat.com/AbleFondChick-size_restricted.gif"
            />
          </div>
        </div>
        <br />
