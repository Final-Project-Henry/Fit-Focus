...
const HomeRegister = () => {
    ...
    return (
        <div className="max-w-screen-lg my-12 mx-auto overflow-hidden bg-slate-50 rounded-md shadow-lg">
            ...
            <br />
            <hr />
            <h1 className="text-center text-3xl mt-10 font-semibold">EJERCICIOS DEL DIA</h1>
            <hr />
            <br />
            {
                exercises.length && (
                    <div>
                        <h1 className="font-bold text-center text-2xl">EJERCICIOS PARA TRONCO</h1>
                    <Swiper
                        slidesPerView={3}
                        spaceBetween={30}
                        slidesPerGroup={3}
                            ...
                            if (muscles === "upper_body")
                                return (
                                    <SwiperSlide className="bg-transparent h-auto">
                                        <div key={_id} className={` scale-90 rounded overflow-hidden shadow-lg cursor-pointer duration-300 hover:duration-200 hover:scale-95 hover:outline hover:outline-offset-1 ${difficulty == "easy" ? "outline-green-400" : difficulty == "medium" ? "outline-yellow-400" : "outline-red-400"}`}>
                    ...
                    <h1 className="font-bold text-center text-2xl">EJERCICIOS PARA PIERNAS</h1>
                    <Swiper
                        slidesPerView={3}
                        spaceBetween={30}
                        slidesPerGroup={3}
