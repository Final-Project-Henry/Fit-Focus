        ...
        <main className='mt-10'>
          <div className='mb-4 md:mb-0 w-full mx-auto relative'>
            <div className='px-4 lg:px-0'>
              <h2 className='text-4xl font-semibold text-gray-800 leading-tight'>{newsData?.title}</h2>
              <a href='#' className='py-2 text-green-700 inline-flex items-center justify-center mb-2'>
                {/* tags */}
              </a>
            </div>
            <img src={newsData?.image} className='w-full object-cover lg:rounded' style={{ height: '28em' }} />
          </div>
            ...
            <div className='w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm'>
              <div className='p-4 border-t border-b md:border md:rounded'>
                <div className='flex py-2'>
                  ...
                  />
                  <div>
                    <p className='font-semibold text-gray-700 text-sm'>Adrian Acurero</p>
