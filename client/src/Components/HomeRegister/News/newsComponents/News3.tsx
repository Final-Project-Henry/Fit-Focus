...
const News3 = () => {
    return (
        <div>
            ...
            >
                <div
                    id="93ae7bdc-2dec-4e1f-afd5-6d07233ae8cd"
                    data-qa="grid-row"
                            ...
                            >
                                ...
                                >
                                    <p>
                                        ...
                                        . ¿Pero también deberías ejercitarte? No necesariamente. De
                                        hecho, algunos entrenamientos pueden incluso retrasar la
                                        recuperación de una enfermedad.
                                    </p>
                                    <p>
                                        Dicho esto, existen algunas situaciones en las que estaría bien
            ...
            >
                <div
                    id="8fbf0b97-29c1-4ecd-aa20-9d515dac9e7a"
                    data-qa="grid-row"
                    className="ncss-row grid-row"
                >
                    <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p>
                                        ...
                                        del cuello es seguro e incluso puede ser beneficioso. "Si tienes
                                        síntomas de las vías respiratorias altas, como tos leve o goteo
                                        nasal, salir a caminar o trotar puede hacer que te sientas
                                        mejor. Puede despejar la sinusitis y aliviar la congestión
                                        nasal", dice Bharati.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        , especialista en medicina deportiva y jefe de la división de
                                        atención primaria de medicina deportiva en NYU Langone Health.
                                    ...
                                    <p>
                                        ...
                                        , la miocarditis puede reducir la habilidad del corazón para
                                    ...
                                    <p>
                                        ...
                                        cuerpo está menguado solo generará más fatiga y deshidratación,
                                    ...
                                    <p>
                                        ...
                                        <a
                                            ...
                                            href="https://www.nike.com/us/es/a/cuanta-agua-hay-que-beber-diariamente"
                                        >
                                            Según los expertos, esta es la cantidad exacta de agua que
                                            deberías consumir diariamente
                                        </a>
                                    </p>
                                </div>
                            </div>
            ...
            >
                <div
                    id="520cce37-d01e-421a-b888-902d4bbaea96"
                    data-qa="grid-row"
                    className="ncss-row grid-row"
                >
                    <div
                    ...
                    >
                        <div>
                            ...
                            >
                                ...
                                >
                                    <p>
                                        Para entrenar, no es necesario que esperes hasta sentirte al 100
                                        por ciento, pero al menos deberías estar en un 90 por ciento.
                                        Eso significa que tus niveles de energía estarán cercanos a lo
                                        normal, la mente se habrá despejado y la hidratación y la
                                        nutrición ya se habrán normalizado. También es posible que
                                        comiences a anhelar el ejercicio nuevamente: "Todas las señales
                                        indican 'avanzar'", dice Cardone.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <strong className="u-bold">
                                            Cómo ejercitarte de manera segura cuando sigues en
                                            recuperación
                                        </strong>
                                    </p>
                                    <p>
                                        Si eliges hacer ejercicio físico durante la recuperación, lo
                                    ...
                                    <p>
                                        La intensidad del entrenamiento variará dependiendo de los
                                        síntomas y de cuánto tiempo haya pasado desde la última vez que
                                        te ejercitaste. En cualquier caso, no creas que estarás al cien
                                        por ciento en tu primer entrenamiento. "Para las personas es
                                        fácil debilitarse y perder la condición física con solo unos
                                        pocos días de no hacer nada. Recuperarse y volver a estar al
                                        mismo nivel toma tiempo", dice Cardone.
                                    </p>
                                    <p>
                                        Cuando retomes el ejercicio físico, apunta a aplicar un 50 por
                                        ciento de tu intensidad normal, como máximo. "Va a depender de
                                        cuánto tiempo haya transcurrido desde tu último entrenamiento,
                                        pero el 50 por ciento es una buena regla general", dice Cardone.
                                    </p>
                                    <p>
                                        ...
                                        , remo o elíptica al principio durante una o dos semanas para
                                        aumentar gradualmente el impacto y la intensidad, recomienda
                                        Cardone. Sin embargo, es posible que estas actividades de bajo
                                    ...
                                    <p>
                                        ...
                                        pesas, reduce la carga habitual al menos a la mitad. "Ahora no
                                        es el momento de poner a prueba cuánto peso muerto puedes
                                        levantar", dice Bharati. Otra buena medida es rebajar la
                                        duración y la frecuencia del entrenamiento.
                                    </p>
                                    <p>
                                        Para volver a entrenar luego de una enfermedad, Bharati y
                                        Cardone recomiendan probar primero estos ejercicios:
                                    </p>
                                    <ul>
                                    ...
                                    <p>
                                        Por el contrario, afirman que los peores ejercicios para la
                                        recuperación de una enfermedad incluyen:
                                    </p>
                                    <ul>
                                        <li>
                                            <a
                                    ...
                                    <p>
                                        Sin importar qué actividad hagas, trabaja a una intensidad que
                                        te permita mantener una conversación con comodidad.
                                    </p>
                                    <p>
                                        Presta atención a cómo te sientes durante los entrenamientos. Si
                                        las cosas van bien, aumenta la intensidad de un 10 a un 20 por
                                        ciento y fíjate cómo te sientes. Sigue aumentando la intensidad
                                        de un 10 a un 20 por ciento hasta llegar al nivel que tenías
                                        antes de enfermarte.
                                    </p>
                                    <p>
                                        Si comienzas a sentir aturdimiento, náuseas, fatiga o dolor,
                                        interrumpe el entrenamiento o baja la intensidad.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                <div
                    id="ae8cdda0-e146-4b98-a702-da74bb57bc73"
                    data-qa="grid-row"
                    className="ncss-row grid-row"
                >
                    <div
                    ...
                    >
                        <div>
                            ...
                            >
                                ...
                                >
                                    <p>
                                        Mientras te recuperas de la enfermedad, presta especial atención
            ...
            >
                <div
                    id="fb6cde71-afd2-4953-ae18-8652b4928c6c"
                    data-qa="grid-row"
                    className="ncss-row grid-row"
                >
                    <div
                            ...
                            >
                                ...
                                >
                                    <p>
                                        ...
                                        , incluso los niveles bajos de actividad física se asocian con
                                        un riesgo de contraer infecciones bacterianas un 10 por ciento
                                        más bajo que en el caso de las personas sedentarias.
                                    </p>
                                    <p>
                                        Piensa en tu sistema inmunitario como si fuera tu corazón y
                                        pulmones. Con el tiempo, el ejercicio físico desafía el corazón
                                        y los pulmones, fortaleciéndolos y aumentando su eficiencia. Lo
                                        mismo sucede con el sistema inmunitario.
                                    </p>
                                    <p>
                                        Por otro lado, los efectos del ejercicio sobre este sistema a
                                        corto plazo son aún motivo de debate.
                                    </p>
                                    <p>
                                        ...
                                        , se tiene la idea de que los períodos de ejercicio intenso
                                        reducen temporalmente la cantidad de anticuerpos y otras células
                                        inmunitarias que circulan en la sangre. Esto aumenta el riesgo
                                        de infección.
                                    </p>
                                    <p>
                                        Sin embargo, otros expertos argumentan que, luego del ejercicio
                                        físico, el sistema inmunitario tiene una mayor respuesta frente
                                        a amenazas potenciales. Según una evaluación de 2016, la idea es
                                        que los anticuerpos y las células inmunitarias se alejan del
                                        torrente sanguíneo para buscar células dañadas o infectadas en
                                        otros lugares.
                                    </p>
                                </div>
                            </div>
            ...
            >
                <div
                    id="cdf7b2cf-192a-45f5-a403-af46c1e6b33e"
                    data-qa="grid-row"
                    className="ncss-row grid-row"
                >
                    <div
                            ...
                            >
                                ...
                                >
                                    <p>
                                        ...
                                        sistema inmunitario a largo plazo superan cualquier desventaja
                                        potencial. A menos que, por supuesto, estés lidiando con fiebre
                                        o recuperándote de un resfriado. Si te aqueja una enfermedad o
                                        tienes síntomas residuales como fatiga y dolor corporal, date un
