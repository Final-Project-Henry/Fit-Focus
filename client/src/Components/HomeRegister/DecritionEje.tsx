...
export default function DecriptionEjer() {
  ...
  const [descripcionEjersicio, setdescripcionEjersicio] =
    useState<ejerciciosData>();
  ...
  useEffect(() => {
    ...
    const favExisited = user?.fav.find(
      (x: any) => x._id === descripcionEjersicio?._id
    );
              ...
              <div className="py-5">
                {
                  <button
                    onClick={() => AddFavorite()}
                    className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-[#6c63ff] duration-150  hover:bg-blue-800"
                  >
        ...
        <form>
          <div className="mt-10 mb-10 m-auto w-[95%] bg-gray-50  border border-gray-200">
            ...
            <div className="flex justify-between items-center py-2 px-3 border-t dark:border-gray-600">
              <button
                type="submit"
                className="inline-flex items-center py-2.5 px-6 text-xs font-medium text-center text-white bg-blue-700 focus:ring-4 focus:ring-blue-200  hover:bg-blue-800"
              >
                Enviar
              </button>
            </div>
