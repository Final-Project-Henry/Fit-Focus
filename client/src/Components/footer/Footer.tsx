...
const Footer = () => {
  ...
  function handleChange(event: React.ChangeEvent<HTMLFormElement | HTMLInputElement | HTMLTextAreaElement>): void {
      ...
      <div className='md:flex md:justify-between h-80'>
        <div className='mb-6 md:mb-0 '>
          ...
          <div id='feedbacks' className='mt-5 md:mb-0'>
            <span className='mb-6 text-sm font-semibold uppercase text-white ml-5 '>Dejanos tu opinión:</span>
        ...
        <div className='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
          <div>
            <h2 className='mb-6 text-sm font-semibold  uppercase text-white'>Colaboración</h2>
