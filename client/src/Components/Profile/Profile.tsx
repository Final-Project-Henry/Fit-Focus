                        ...
                        <g transform="translate(1716.000000, 291.000000)">
                          <g transform="translate(1.000000, 0.000000)">
                            <path
                              onClick={() => handleClickAside("profile")}
                              className={`${
                                styles.selected !== "profile" && styles.path
                              } duration-500 opacity-60`}
                        ...
                        <g transform="translate(1716.000000, 291.000000)">
                          <g transform="translate(453.000000, 454.000000)">
                            <path
                              onClick={() => handleClickAside("pay")}
                              className={`${
                                styles.selected !== "pay" && styles.path
                              } opacity-60 duration-500`}
                ...
                >
                  ...
                  >
                    <path
                      onClick={() => handleClickAside("logOut")}
                      className={`${
                        styles.selected === "logOut" && "fill-white"
                      } duration-500`}
                  ...
                  >
                    ...
                    <g>
                      ...
                      >
                        <polygon
                          className={`${
                            styles.selected === "remove" && "fill-white"
                          } duration-500`}
                          id="Fill-6"
                  ...
                  >
                    ...
                    >
                      <g>
                        <path
                          className={`${
                            hover.hoverCamera && hover.pathCamera
                  ...
                  {hiddenButtons && (
                    <div className="w-[200px] flex justify-between">
                      ...
                      >
                        <svg
                          className={`${
                            hover.hoverUpload && hover.pathUpload
                          } delay-100 w-5 h-5 mb-[3px] inline`}
                          xmlns="http://www.w3.org/2000/svg"
                          xmlnsXlink="http://www.w3.org/1999/xlink"
                          version="1.1"
                          id="Capa_1"
            ...
            <div className="flex flex-wrap items-center -mx-3 lg:justify-between">
              <div className="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                <div className="leading-normal text-center text-size-sm text-slate-500 lg:text-left">
                  © 2022, Desarrollado por el equipo de
                  <i className="fa fa-heart" aria-hidden="true"></i>
                  <a
                    href="localhost:3000/hola"
