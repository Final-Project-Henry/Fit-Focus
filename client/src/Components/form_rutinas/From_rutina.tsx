...
export default function Form_rutinas(props: { function: { (): void } }) {
  ...
  function handleChange(
    event: React.ChangeEvent<HTMLFormElement | HTMLInputElement | HTMLTextAreaElement | any>,
  ): void {
            ...
            <div className=' bg-gray-200 px-20 py-10 bg-opacity-80 '>
              ...
              <div className='flex justify-start mt-5'>
                ...
                <input
                  ...
                  onClick={() => Set_form_data((pv: any) => ({ ...pv, equipment: false }))}
                />
                ...
                <input
                  ...
                  onClick={() => Set_form_data((pv: any) => ({ ...pv, equipment: true }))}
                />
                <label>Si</label>
              </div>
              <div className='flex justify-start mt-5'>
