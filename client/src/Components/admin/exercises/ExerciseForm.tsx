    ...
    <div style={{ margin: '0 auto' }}>
      <div className='w-full px-24 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-md sm:rounded-lg m-auto'>
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col'>
          ...
          <div className='mt-4'>
            <label htmlFor='difficulty' className='block text-sm font-medium text-gray-700 undefined'>
              Dificultad
            </label>
            <select
              id='difficulty'
          ...
          <div className='mt-4'>
            <label htmlFor='muscles' className='block text-sm font-medium text-gray-700 undefined'>
              Musculos
            </label>
            <select
              id='muscles'
          ...
          <div className='mt-4'>
            <label htmlFor='genre' className='block text-sm font-medium text-gray-700 undefined'>
              Género
            </label>
            <select
              id='genre'
          ...
          <div className='mt-4'>
            <label htmlFor='video' className='block text-sm font-medium text-gray-700 undefined'>
              Video
            </label>
            <div className='flex flex-col items-start'>
              <input
          ...
          <div className='mt-4'>
            <label htmlFor='premium' className='block text-sm font-medium text-gray-700 undefined'>
              Premium
            </label>
            <select
              id='premium'
          ...
          <div className='mt-4'>
            <label htmlFor='description' className='block text-sm font-medium text-gray-700 undefined'>
              Descripción
            </label>
            <div className='flex flex-col items-start'>
              <textarea
