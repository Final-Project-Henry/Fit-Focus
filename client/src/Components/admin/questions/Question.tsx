...
export default function Question(props: { datos: datos; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className='p-4'>
        <button className='bg-gray-900 text-white p-2 rounded ' onClick={handleResp}>
          Responder
        </button>
      </div>
      {isResponse && (
        <div className='grid grid-cols-1'>
          ...
          />
          <button className='bg-green-700 w-20 m-auto text-white rounded p-2 my-4' onClick={handleSend}>
            Enviar
          </button>
        </div>
      )}
