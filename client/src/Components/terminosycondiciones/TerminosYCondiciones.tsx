        ...
        <div>
            <div className='border-2 text-justify w-[80%] mt-5 mb-[5%] ml-[9%]'>
                <p className='mx-[20px] mt-[10px] mb-[10px]'>
                    ...
                    <br />
                    1.1 El acceso y uso por usted de los Sitios y los servicios, el software y los productos de <b>FIT FOCUS</b> a través de los Sitios, lo cual incluirá las plataformas web está sujeto a los términos y las condiciones contenidos en este documento, así como en la Política de privacidad, la Política de listado de ejercicios y cualquier otra normativa y política de los Sitios que pueda publicar <b>FIT FOCUS</b> puntualmente. En lo sucesivo, el presente documento y dichas otras normativas y políticas de los Sitios se denominan, conjuntamente, los "Términos". Al acceder a y utilizar los Sitios y Servicios, usted se compromete a aceptar y someterse (BAJO SU PROPIA RESPONSABILIDAD) a estos Términos de uso. Por favor, no acceda o utilice los Servicios o los Sitios si no acepta todos los Términos.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    1.2 Usted no puede acceder o utilizar los Servicios o los Sitios ni aceptar las Términos si (a) no tiene la edad legal para formalizar un acuerdo vinculante con <b>FIT FOCUS</b>, o (b) no está en las condiciones adecuadas para ejercitarse con la aplicaciones.
                    <br />
                    <br />
                    1.3 <b>FIT FOCUS</b> podrá modificar cualquiera de los Términos en cualquier momento mediante la publicación de la modificación correspondiente y los Términos actualizados en los Sitios. Al continuar accediendo o utilizando los Servicios o los Sitios, usted acepta que los Términos modificados y refundidos son de la aplicación.
                    <br />
                    <br />
                    1.4 Si <b>FIT FOCUS</b> ha publicado o proporcionado una traducción de la versión en inglés de los Términos, usted acepta que la traducción se proporciona únicamente por conveniencia y que cualquier versión regirá su acceso y uso de los Servicios o los Sitios.
                    <br />
                    <br />
                    1.6 Los Términos solo podrán ser modificados por escrito por el conjunto de integrantes del equipo de <b>FIT FOCUS</b>.
                </p>
            </div>
        </div>
    )
