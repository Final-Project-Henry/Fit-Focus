...
import { User_Register_State, selectUser, Estado, Status, Error } from '../../features/counter/counterSlice'
...
const SignUp: React.FC<Propos> = ({ loading_icon, icon }) => {
  ...
  return (
    <div className='h-full w-full flex justify-center content-center'>
      ...
      {/* component */}
      {typeof user.userToken === 'string' && user.userToken.length > 50 && <Navigate to='/fitFocus' />}
      <div className='py-6 flex-1 content-center justify-center '>
        <div className='flex bg-white shadow-2xl overflow-hidden mx-auto  max-w-md h-auto lg:max-w-[75%] xl:max-w-[68%] '>
          ...
          >
            <h1 style={{ color: 'white', fontSize: '2rem', width: '20vw', marginLeft: '7vw', marginTop: '30vh' }}>
              “La clave para iniciar algo es dejar de hablar y ponerse a hacerlo”
            </h1>
          </div>
          <div className='w-full p-8 lg:w-1/2'>
            <h2 className='text-2xl font-semibold text-gray-700 text-center'>Registrate</h2>
            ...
            <div className='mt-4'>
              <label className='ml-2 mb-[8px] text-sm font-medium text-gray-600 '>
                Al registrarse, usted está aceptando los terminos y condiciones de la aplicacion
              </label>
              <button className='bg-gray-700 text-white font-bold py-2 px-4 w-full :bg-gray-600' onClick={handleSubmit}>
            ...
            <div className='mt-4 flex items-center justify-between'>
              ...
              <p className='text-xs text-center text-gray-500 uppercase'>o registrate con google</p>
              <span className='border-b w-1/5 lg:w-1/4' />
            </div>
            ...
            <div className='mt-4 flex items-center justify-between'>
              ...
              <Link to='/auth/login' className='text-blue-700 hover:underline dark:text-blue-500'>
                inicia sesion
              </Link>
              <span className='border-b w-1/5 md:w-1/4' />
            </div>
