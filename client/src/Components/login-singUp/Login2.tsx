    ...
    return (
        <div className='h-screen flex justify-center content-center'>
            ...
            <div className="py-6 flex-1 content-center justify-center">
                <div className="flex bg-white shadow-lg overflow-hidden mx-auto mt-[6%] max-w-sm h-[60%] lg:max-w-5xl">
                    <div
                    ...
                    <div className="w-full p-8 lg:w-1/2">
                        ...
                        <a
                            href="#"
                            className="flex items-center justify-center mt-4 text-white shadow-md hover:bg-gray-100"
                        >
