          ...
          <div className='flex flex-wrap lg:justify-between -mx-4'>
            <div className='w-full lg:w-1/2 xl:w-6/12 px-4'>
              <div className='max-w-[570px] mb-12 lg:mb-0'>
                <span className='block mb-4 text-base text-primary font-semibold'>Danos tu opinión</span>
                <h2
                  className='
            text-gray-900
            mb-6
            ...
            '
                ...
                <p className='text-lg text-body-color leading-relaxed mb-9'>
                  Por este medio vas a poder realizar cualquier tipo de duda y/o consulta sin costo adicional. Espere a
                  ser respondido por nuestro equipo técnico.
