...
export default function Calculadora2(props: {
  function: { (imc: number): void }
  info: { (peso: number, altura: number): void }
}) {
  ...
  return (
    <div className={styles.app}>
      ...
      <div className={styles.btns_group}>
        <button className={styles.btns} onClick={calcularIMC}>
          Calcular
        </button>
        <button className={styles.btns} onClick={onReset}>
          Limpiar
        </button>
      </div>
    </div>
