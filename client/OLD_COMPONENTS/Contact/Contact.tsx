...
import { getProfileInfo, selectUser, userFeedback } from '../../features/counter/counterSlice'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ width: '35vw', fontSize: '1rem', marginTop: '10px', textAlign: 'justify' }}>
              Te agradecemos que dediques un momento para darnos tu opinion, su objetivo es ayudarnos a conocerte mejor
              y encontrar formas de seguir mejorando, y que asi, pueda seguir ayudandote a cambiar tu estilo de vida. La
              mejor parte de esto es que, con tu apoyo, esta app te sera de mas ayuda en tu meta por tener un vida mas
              sana.
            </p>
          </div>
        </div>
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)} style={{ textAlign: 'center', width: '85%', height: '90%' }}>
            <input
              type='email'
              placeholder='Correo...'
              id='Nombre'
